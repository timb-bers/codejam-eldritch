...
## Описание проекта
Необходимо создать небольшое приложение-хелпер для настольной игры "Древний Ужас"

## Ссылка на проект
https://timb-bers.github.io/codejam-eldritch/
...
1. На выбор предоставляется минимум одна карта древнего (максимум 4)
2. На выбор предоставляется несколько уровней сложности (максимум 5)
3. Карты замешиваются согласно правилам игры
4. Есть трекер текущего состояния колоды
